...
const FilterSecion = () => {
    ...
    // Unique data 
    const cagetoryOnlyData = getUniqueData(all_products, "category");
    ...
    return (
        <Wrapper>
            ...
            <div className="filter-category">
              ...
              <div>
              {
                cagetoryOnlyData.map((curElem, index)=>{
                ...
                <select name="company" id="company" className="filter-company--select" onClick={upDateFilterValue}>
                  {
                    companyOnlyData.map((curElem, index)=>{
                      return <option key={index} type="button" value={curElem} name="company">{curElem}</option>
                    })
                  }
                </select>
              </form>
              ...
              <div className="filter-color-style">
                {
                     colorsData.map((curColor, index) => {
                      if(curColor === "All") {
                        return (<button key={index} type="button" value={curColor} name="color" className="color-all--style"
                        onClick={upDateFilterValue}
                        >All</button>
                        );
                      }
                      else {
                        return (<button key={index} type="button" value={curColor} name="color" style={{backgroundColor: curColor}} 
